...
This project includes the [Heracles](https://github.com/ncas-tum/heracles) (Copyright (c) 2024-2025 University of Groningen) binaries which are [licensed under the MIT license](https://github.com/ncas-tum/heracles/blob/main/LICENSE).
